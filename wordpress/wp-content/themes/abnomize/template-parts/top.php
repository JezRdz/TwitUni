...
<span type="button" data-toggle="offCanvas"><ul class="menu"> <li><span><?php esc_html(' Menu','abnomize'); ?> 
 <?php if ( abnomize_the_custom_logo()  ) {
      abnomize_the_custom_logo();
   }
   else {
...
<div class="row">
 ...
 <?php if ( abnomize_the_custom_logo()  ) {
  ...
  <div class="large-8 columns">  <nav id="site-navigation" class="main-navigation" role="navigation">
			<button class="menu-toggle" aria-controls="primary-menu" aria-expanded="false"><?php esc_html_e( 'Primary Menu', 'abnomize' ); ?></button>
